...
userInput.addEventListener("keyup", ()=>{
    const searchAProduct = document.getElementById("inputName").value.toLowerCase().trim();
...
userCountry.addEventListener("change", ()=>{
    ...
    switch(searchedCountry){
        ...
        case "germany": renderProducts(products.filter(a=>a.shipsTo.includes("Germany")));break;
        case "iceland": renderProducts(products.filter(a=>a.shipsTo.includes("Iceland")));break;
